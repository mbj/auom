...
begin
  ...
  task :heckle => :rcov do
    ...
    root_module_regexp = Regexp.union('AUOM')
    ...
    aliases['AUOM::Algebra']['-']     = 'substract'
    aliases['AUOM::Algebra']['*']     = 'multiply'
    aliases['AUOM::Algebra']['/']     = 'divide'
    aliases['AUOM::Algebra']['+']     = 'add'
    ...
    ObjectSpace.each_object(Module) do |mod|
      ...
      specs.sort.each do |(method, spec_files)|
        ...
        command = "spec #{spec_files.join(' ')} --heckle '#{mod}#{method}'"
        puts command
